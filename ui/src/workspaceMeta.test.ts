...
assert.equal(compactTargetFromEnv({SCENEFORGE_AUTO_COMPACT_TOKEN_THRESHOLD: '100', SCENEFORGE_AUTO_COMPACT_BUFFER_TOKENS: '30'}), 70);
assert.equal(compactTargetFromEnv({SCENEFORGE_CONTEXT_WINDOW_TOKENS: '400000', SCENEFORGE_AUTO_COMPACT_RATIO: '0.9', SCENEFORGE_AUTO_COMPACT_BUFFER_TOKENS: '30000'}), 330000);
...
assert.equal(resolveWorkspacePath('/repo', '20260608-sceneforge'), '.working_dir/20260608-sceneforge');
