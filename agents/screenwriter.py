...
class Screenwriter:
    def __init__(
        ...
        # Appended to every system prompt; used to inject the Chinese-runtime
        # constraint so spoken content is generated in Chinese regardless of
        # whether the base prompt is later externalised/edited (design §14).
    ...
    async def develop_story(
        ...
        messages = [
            ("system", self._system(system_prompt_template_develop_story)),
    ...
    async def write_script_based_on_story(
        ...
        messages = [
            ("system", self._system(system_prompt_template_write_script_based_on_story.format(format_instructions=format_instructions))),
