...
class AgentConfigTests(unittest.TestCase):
    ...
    def test_environment_overrides_agent_local_config(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch.dict(os.environ, {"SCENEFORGE_LLM_MODEL": "env-llm", "SCENEFORGE_LLM_MODEL_PROVIDER": "openai", "SCENEFORGE_LLM_API_KEY": "env-key", "SCENEFORGE_VIDEO_BASE_URL": "https://openrouter.ai/api/v1", "SCENEFORGE_EMBEDDING_MODEL": "env-embedding", "SCENEFORGE_EMBEDDING_BASE_URL": "https://env-embedding.test/v1", "SCENEFORGE_EMBEDDING_API_KEY": "env-embedding-key", "SCENEFORGE_RERANKER_MODEL": "env-reranker", "SCENEFORGE_RERANKER_BASE_URL": "https://env-reranker.test", "SCENEFORGE_RERANKER_API_KEY": "env-reranker-key"}, clear=True):
